...
pub const LIMINE_PAGING_MODE_LOONGARCH64_4LVL: u32 = 0;
pub const LIMINE_PAGING_MODE_MAX: u32 = 0;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of limine_smp_info"][::core::mem::size_of::<limine_smp_info>() - 8usize];
    ["Alignment of limine_smp_info"][::core::mem::align_of::<limine_smp_info>() - 8usize];
    ["Offset of field: limine_smp_info::reserved"]
        [::core::mem::offset_of!(limine_smp_info, reserved) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of limine_smp_response"][::core::mem::size_of::<limine_smp_response>() - 16usize];
    ...
    ["Offset of field: limine_smp_response::cpu_count"]
        [::core::mem::offset_of!(limine_smp_response, cpu_count) - 0usize];
    ["Offset of field: limine_smp_response::cpus"]
        [::core::mem::offset_of!(limine_smp_response, cpus) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
