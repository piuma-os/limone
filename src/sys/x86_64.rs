...
pub const LIMINE_SMP_X2APIC: u32 = 1;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of limine_smp_info"][::core::mem::size_of::<limine_smp_info>() - 32usize];
    ...
    ["Offset of field: limine_smp_info::lapic_id"]
        [::core::mem::offset_of!(limine_smp_info, lapic_id) - 4usize];
    ["Offset of field: limine_smp_info::reserved"]
        [::core::mem::offset_of!(limine_smp_info, reserved) - 8usize];
    ["Offset of field: limine_smp_info::goto_address"]
        [::core::mem::offset_of!(limine_smp_info, goto_address) - 16usize];
    ["Offset of field: limine_smp_info::extra_argument"]
        [::core::mem::offset_of!(limine_smp_info, extra_argument) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of limine_smp_response"][::core::mem::size_of::<limine_smp_response>() - 32usize];
    ...
    ["Offset of field: limine_smp_response::bsp_lapic_id"]
        [::core::mem::offset_of!(limine_smp_response, bsp_lapic_id) - 12usize];
    ["Offset of field: limine_smp_response::cpu_count"]
        [::core::mem::offset_of!(limine_smp_response, cpu_count) - 16usize];
    ["Offset of field: limine_smp_response::cpus"]
        [::core::mem::offset_of!(limine_smp_response, cpus) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
